...
const InfoContainer = () => {
    return(
        <div className="flex flex-col items-center bg-zinc-400 hover:bg-zinc-300 dark:bg-zinc-900 dark:hover:bg-zinc-800 rounded-2xl mx-3 mb-3 mt-3 space-y-3 md:hidden lg:flex">
