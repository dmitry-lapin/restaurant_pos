...
const BtnCategoryWrapper = ({ category, icon, description, onClick }) => {
    return (
      <button className="group border  rounded-lg px-4 py-3 duration-100 border-1 border-zinc-300 hover:border-zinc-400 bg-gray-200  hover:bg-gray-300 text-zinc-950 dark:text-gray-300 dark:bg-zinc-900 dark:border-zinc-950" onClick={() => onClick(category)}>
